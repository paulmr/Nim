...
function nsuFindChar(s_838862324, sub_838862325, start_838862326, last_838862327) {
    var Temporary1;

  var result_838862328 = 0;
  ...
  BeforeRet: do {
    F.line = 1864;
    if ((last_838862327 == 0)) {
    Temporary1 = (s_838862324).length - 1;
    }
    else {
    Temporary1 = last_838862327;
    }
    
    var last_838862329 = Temporary1;
    Label2: do {
      F.line = 1876;
      var i_838862339 = 0;
      F.line = 75;
      ...
      F.line = 1876;
      colontmp__822083689 = start_838862326;
      F.line = 90;
      var res_822083690 = colontmp__822083689;
      Label3: do {
        F.line = 91;
          Label4: while (true) {
          if (!(res_822083690 <= last_838862329)) break Label4;
            F.line = 1876;
            i_838862339 = res_822083690;
            if ((sub_838862325 == s_838862324[chckIndx(i_838862339, 0, (s_838862324).length - 1)])) {
            F.line = 1877;
            result_838862328 = i_838862339;
            break BeforeRet;
            }
  ...
  return result_838862328;

}

function fill_838862266(a_838862268, value_838862269) {
  var F = {procname: "fill.fill", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/algorithm.nim", line: 0};
  framePtr = F;
    F.line = 68;
    var xHEX60gensym166_838862275 = 0;
    Label1: do {
      F.line = 94;
        Label2: while (true) {
        if (!(xHEX60gensym166_838862275 <= (a_838862268).length - 1)) break Label2;
          F.line = 94;
          a_838862268[chckIndx(xHEX60gensym166_838862275, 0, (a_838862268).length - 1)] = value_838862269;
          F.line = 71;
          xHEX60gensym166_838862275 = addInt(xHEX60gensym166_838862275, 1);
        }
    } while (false);
  framePtr = F.prev;
...
function nsuInitSkipTable(a_838862263, sub_838862264) {
  var F = {procname: "strutils.initSkipTable", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
    F.line = 1807;
    var m_838862265 = (sub_838862264).length;
    F.line = 1808;
    fill_838862266(a_838862263, m_838862265);
    Label1: do {
      F.line = 1810;
      var i_838862284 = 0;
      F.line = 117;
      ...
      F.line = 1810;
      colontmp__822083693 = subInt(m_838862265, 1);
      F.line = 119;
      var i_822083694 = 0;
      Label2: do {
        F.line = 120;
          ...
          if (!(i_822083694 < colontmp__822083693)) break Label3;
            F.line = 1810;
            i_838862284 = i_822083694;
            F.line = 1811;
            a_838862263[chckIndx(sub_838862264[chckIndx(i_838862284, 0, (sub_838862264).length - 1)], 0, (a_838862263).length - 1)] = subInt(subInt(m_838862265, 1), i_838862284);
            F.line = 122;
...
function nsuFindStrA(a_838862304, s_838862305, sub_838862306, start_838862307, last_838862308) {
    var Temporary1;

  var result_838862309 = 0;
  ...
  BeforeRet: do {
    F.line = 1821;
    if ((last_838862308 == 0)) {
    Temporary1 = (s_838862305).length - 1;
    }
    else {
    Temporary1 = last_838862308;
    }
    
    var last_838862310 = Temporary1;
    F.line = 1822;
    var subLast_838862311 = subInt((sub_838862306).length, 1);
    if ((subLast_838862311 == -1)) {
    F.line = 1827;
    result_838862309 = start_838862307;
    break BeforeRet;
    }
    
    F.line = 1831;
    var skip_838862312 = start_838862307;
    Label2: do {
      F.line = 1833;
        Label3: while (true) {
        if (!(subLast_838862311 <= subInt(last_838862310, skip_838862312))) break Label3;
          F.line = 1834;
          var i_838862313 = subLast_838862311;
          Label4: do {
            F.line = 1835;
              Label5: while (true) {
              if (!(s_838862305[chckIndx(addInt(skip_838862312, i_838862313), 0, (s_838862305).length - 1)] == sub_838862306[chckIndx(i_838862313, 0, (sub_838862306).length - 1)])) break Label5;
                if ((i_838862313 == 0)) {
                F.line = 1837;
                result_838862309 = skip_838862312;
                break BeforeRet;
                }
                
                F.line = 1838;
                i_838862313 = subInt(i_838862313, 1);
              }
          } while (false);
          F.line = 1839;
          skip_838862312 = addInt(skip_838862312, a_838862304[chckIndx(s_838862305[chckIndx(addInt(skip_838862312, subLast_838862311), 0, (s_838862305).length - 1)], 0, (a_838862304).length - 1)]);
        }
    } while (false);
    F.line = 1840;
    result_838862309 = -1;
  ...
  return result_838862309;

}

function nsuFindStr(s_838862357, sub_838862358, start_838862359, last_838862360) {
  var result_838862361 = 0;

  var F = {procname: "strutils.find", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
  BeforeRet: do {
    if ((subInt((s_838862357).length, start_838862359) < (sub_838862358).length)) {
    F.line = 1909;
    result_838862361 = -1;
    break BeforeRet;
    }
    
    if (((sub_838862358).length == 1)) {
    F.line = 1910;
    result_838862361 = nsuFindChar(s_838862357, sub_838862358[chckIndx(0, 0, (sub_838862358).length - 1)], start_838862359, last_838862360);
    break BeforeRet;
    }
    
    F.line = 1913;
    var a_838862363 = [new Int32Array(256)];
    F.line = 1914;
    nsuInitSkipTable(a_838862363[0], sub_838862358);
    F.line = 1915;
    result_838862361 = nsuFindStrA(a_838862363[0], s_838862357, sub_838862358, start_838862359, last_838862360);
  } while (false);
  framePtr = F.prev;

  return result_838862361;

}

function contains_838862486(s_838862487, sub_838862488) {
  var result_838862489 = false;

  var F = {procname: "strutils.contains", prev: framePtr, filename: "/home/runner/work/Nim/Nim/lib/pure/strutils.nim", line: 0};
  framePtr = F;
  BeforeRet: do {
    F.line = 2070;
    result_838862489 = (0 <= nsuFindStr(s_838862487, sub_838862488, 0, 0));
    break BeforeRet;
  } while (false);
  framePtr = F.prev;

  return result_838862489;
...
function HEX3Aanonymous_822083650(r_822083651) {
  ...
  BeforeRet: do {
    ...
    if (!(contains_838862486(cstrToNimstr(reason_822083617.message), makeNimstrLit("foobar: 7")))) {
    F.line = 236;
